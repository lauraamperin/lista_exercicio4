...
df_agrupada.plot(df_agrupada["Ano"], df_agrupada["Margem Líquida"], label='Margem Líquida (%)', ax=ax)
df_agrupada.plot(df_agrupada["Ano"], df_agrupada["ROA"], label='ROA (%)', ax=ax)
plt.title("Margem Líquida e ROA da Empresa por Ano")
